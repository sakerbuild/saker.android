...
public class AndroidResourcesLocalInputFileContentsExecutionProperty
	 ...
	 */
	public AndroidResourcesLocalInputFileContentsExecutionProperty() {
	}

	public AndroidResourcesLocalInputFileContentsExecutionProperty(SakerPath path, Object taskId) {
		this.path = path;
		this.taskId = taskId;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AndroidResourcesLocalInputFileContentsExecutionProperty other = (AndroidResourcesLocalInputFileContentsExecutionProperty) obj;
		if (path == null) {
			if (other.path != null)
				return false;
