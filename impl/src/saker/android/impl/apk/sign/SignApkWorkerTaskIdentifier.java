...
public class SignApkWorkerTaskIdentifier implements TaskIdentifier, Externalizable {
	 ...
	 */
	public SignApkWorkerTaskIdentifier() {
	}

	public SignApkWorkerTaskIdentifier(SakerPath outputPath) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SignApkWorkerTaskIdentifier other = (SignApkWorkerTaskIdentifier) obj;
		if (outputPath == null) {
