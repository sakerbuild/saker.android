...
public class ExecutionAarClassesWorkerTaskIdentifier implements TaskIdentifier, Externalizable {
	 ...
	 */
	public ExecutionAarClassesWorkerTaskIdentifier() {
	}

	public ExecutionAarClassesWorkerTaskIdentifier(SakerPath outputPath) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ExecutionAarClassesWorkerTaskIdentifier other = (ExecutionAarClassesWorkerTaskIdentifier) obj;
		if (outputPath == null) {
