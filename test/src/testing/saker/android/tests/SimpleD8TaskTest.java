...
public class SimpleD8TaskTest extends BaseAndroidTestCase {
	...
	protected void runNestTaskTestImpl() throws Throwable {
		runScriptTask("build");
		//check existence
		SakerPath classesdexoutpath = PATH_BUILD_DIRECTORY.resolve("saker.android.d8/src/classes/classes.dex");
		ByteArrayRegion bytes1 = files.getAllBytes(classesdexoutpath);
		...
		runScriptTask("build");
		ByteArrayRegion bytes2 = files.getAllBytes(classesdexoutpath);
